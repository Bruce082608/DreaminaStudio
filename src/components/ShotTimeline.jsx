...
import { Film, Play, AlertCircle, Plus, Trash2, Clock, ChevronDown, Sparkles, Copy, Check, RotateCcw, Cpu } from 'lucide-react';
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-stone-400">细化动作指令、选择角色与生成路由网关</p>
            </div>
          </div>
      ...
      <div className="flex-1 overflow-y-auto space-y-6 pr-1.5 scrollbar-thin">
        {shots.length === 0 ? (
          <div className="text-center py-16 text-stone-400 border-2 border-dashed border-stone-200 rounded-2xl">
            ...
            <p className="text-sm">暂无分镜卡片，请点击“智能拆解分镜”或“添加新分镜”。</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
                  ...
                  <div className="lg:col-span-3 space-y-4">
                    ...
                    <div>
                      <span className="text-xs font-semibold text-stone-700 block mb-2">登场角色 (多选):</span>
                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-semibold text-stone-700">生成引擎:</span>
                        <select
                          value={shot.engine || 'jimeng'}
                          onChange={(e) => onUpdateShot(shot.id, { engine: e.target.value })}
                          className="text-xs bg-stone-50 border border-stone-200 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 rounded-lg p-1.5 text-stone-600 focus:outline-none cursor-pointer"
                        >
                  ...
                  <div className="lg:col-span-2 flex flex-col justify-between">
                    <div className="relative aspect-video w-full bg-stone-50 border border-stone-200/80 rounded-xl overflow-hidden shadow-inner flex flex-col items-center justify-center p-3">
                      ...
                      {shot.status === 'waiting' && (
                        <div className="w-full text-center px-4 animate-pulse">
